...
<html>
	<head>
	<meta charset = "utf-8">
  <link rel="stylesheet" href="Main(logout).css">
    ...
    <div class="main">
      <div class="genre">
				<ul>
					<li><a href="Main(logout).php">すべて</a></li>　　　
					<li class="current"><a href="Main(logout-genre1).php">雑談</a></li>　　　　
					<li><a href="Main(logout-genre2).php">質問</a> </li>　　　
					<li><a href="Main(logout-genre3).php">趣味</a>	</li>　　　
				</ul>
      </div>
			<br>
			<div class="post">
        ...
        //データベースに接続
          ...
          //内容を取得
    		...
    		?>
        <h3>投稿内容</h3>
        <form action="Comment(logout).php" method="GET">
          <?php
    			...
    			?>
    			<a href="Comment(logout).php?keyid=<?php echo urlencode($id); ?>" >
